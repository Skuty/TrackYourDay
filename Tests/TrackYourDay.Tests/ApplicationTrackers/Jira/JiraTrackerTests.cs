...
namespace TrackYourDay.Tests.ApplicationTrackers.Jira
{
    public class JiraTrackerTests
    {
        ...
        public void GivenNoActivitiesWereTrackedAndThereAreJiraActivitiesWaiting_WhenGetingJiraActivities_ThenTrackerShouldReturnOnlyNewActivities()
        {
            ...
            {
                new JiraIssueResponse("KEY-1", "ID-1", new JiraIssueFieldsResponse("Summary 1", new DateTime(2000, 01, 01, 13, 00, 00), null, null, null, null, null, null, null, null, null, null)),
                new JiraIssueResponse("KEY-2", "ID-2", new JiraIssueFieldsResponse("Summary 2", new DateTime(2000, 01, 01, 14, 00, 00), null, null, null, null, null, null, null, null, null, null)),
            };
        ...
        public void GivenTwoActivitiesWereTrackedAndThereTwoMoreActivitiesWaiting_WhenGetingJiraActivities_ThenTrackerShouldReturnFourActivities()
        {
            ...
            var newJiraIssues = new List<JiraIssueResponse>
            {
                new JiraIssueResponse("KEY-3", "ID-3", new JiraIssueFieldsResponse("Summary 3", new DateTime(2000, 01, 01, 17, 00, 00), null, null, null, null, null, null, null, null, null, null)),
                new JiraIssueResponse("KEY-4", "ID-4", new JiraIssueFieldsResponse("Summary 4", new DateTime(2000, 01, 01, 18, 00, 00), null, null, null, null, null, null, null, null, null, null)),
            };
