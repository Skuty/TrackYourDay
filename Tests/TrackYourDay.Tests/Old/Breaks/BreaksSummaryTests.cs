...
namespace TrackYourDay.Tests.Old.Breaks
{
    public class BreaksSummaryTests
    {
        ...
        public void GivenThereIsAtLeastOneBreak_WhenGettingTimeOfAllBreaks_ThenSummedTimeOfAllBreakDurationsIsReturned()
        {
            ...
            var breaks = new List<EndedBreak>
            {
                new EndedBreak(DateTime.Parse("2000-01-01 12:00:00"), DateTime.Parse("2000-01-01 12:01:00")),
                new EndedBreak(DateTime.Parse("2000-01-01 12:10:00"), DateTime.Parse("2000-01-01 12:15:00")),
                new EndedBreak(DateTime.Parse("2000-01-01 13:00:00"), DateTime.Parse("2000-01-01 14:15:00")),
            };
        ...
        public void WhenGettingAmountOfAllBreaks_ThenAmountOfAllBreaksIsReturned()
        {
            ...
            var breaks = new List<EndedBreak>
            {
                new EndedBreak(DateTime.Now, DateTime.Now.AddMinutes(1)),
                new EndedBreak(DateTime.Now, DateTime.Now.AddMinutes(1)),
                new EndedBreak(DateTime.Now, DateTime.Now.AddMinutes(1)),
            };
