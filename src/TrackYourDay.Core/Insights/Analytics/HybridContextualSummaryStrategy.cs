...
namespace TrackYourDay.Core.Insights.Analytics
{
    ...
    public class HybridContextualSummaryStrategy : ISummaryStrategy
    {
        ...
        private ActivityGroup? FindBestMatchingGroup(List<ActivityGroup> groups, ITrackableItem item)
        {
            if (!groups.Any())
                return null;
        ...
        private float CalculateTemporalProximity(ITrackableItem item, ActivityGroup group)
        {
        ...
        {
            private readonly List<ITrackableItem> _items = new();
            private readonly DateOnly _date;

            public string Description { get; private set; }
            public string? JiraKey { get; }

            public ActivityGroup(string description, ITrackableItem firstItem, DateOnly date, string? jiraKey = null)
            {
            ...
            public void AddItem(ITrackableItem item)
            {
                _items.Add(item);
            ...
            public ITrackableItem? GetLastItem()
            {
